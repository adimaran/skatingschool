...
export default function InstructorDashboard() {
  ...
  useEffect(() => {
    async function loadDashboard() {
      ...
      // Fetch the classes from Phase 2 Supabase Database
    ...
    <div className={styles.dashboard}>
      <div className={styles.card} style={{ maxWidth: '800px' }}>
        ...
        <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
          <h2 style={{ borderBottom: '1px solid #eee', paddingBottom: '0.5rem' }}>Available Classes</h2>
          {classes.length === 0 ? (
            <p style={{ color: '#666', marginTop: '1rem' }}>No classes found. Did you run the SQL script?</p>
          ) : (
